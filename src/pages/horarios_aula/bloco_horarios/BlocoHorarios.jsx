...
export function BlocoHorarios ({turno, horarios, mostrarDia, onSubmit, horariosProf, horariosDis, repassarLista, permiteClicar, isJornadaDisciplina, isJornadaProfessor}){
    ...
    useEffect(()=>{}, [horariosProfessor, horariosDisciplina])
            ...
            <div style={{display: "flex", flexDirection: "row", alignItems: "center", justifyContent: "space-between", paddingBottom: "10px"}}>
                ...
                {diasSemana.map((dia, index) => (
                    <DiaHorarios
                      ...
                      horariosProf={getHorarios(diasSemana.indexOf(dia), horariosProfessor)}
                      horariosDis={getHorarios(diasSemana.indexOf(dia), horariosDisciplina)}
